...
public class FScript {
    ...
    /** Constructor 
     * @throws ParseError */
    public FScript() throws ParseError {
     ...
     */
    public FSObject run() throws FSException {
     ...
     * @throws FSException 
     */ 
    public FSObject evaluateExpression(String expr) throws FSException {
        parser.parse(expr);
        return parser.run();
    }
    ...
    **/
    public void exit(FSObject o) throws FSException{
	    parser.exit(o);
    }
...
//    }
     ...
     * @return Object
     */
    protected FSObject getVar(String name) {
    	return FSBuiltin.vars.containsKey(name) ? (FSObject) FSBuiltin.vars.get(name) : FSObject.FSUNDEF;
    }
    ...
    public final void setScriptVar(String name, FSObject value) throws FSException{
   ...
   /**
    ...
    public final FSObject getScriptVar(String name) throws FSException{
    ...
    public final Object callScriptFunction(String name,Vector params) throws FSException {
